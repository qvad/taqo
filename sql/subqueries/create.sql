...
CREATE INDEX t1000000_idx ON t1000000(a) WITH (colocated = true);
CREATE INDEX t500000_idx ON t500000(a) WITH (colocated = true);
CREATE INDEX t50000_idx ON t50000(a) WITH (colocated = true);
CREATE INDEX t100_idx ON t100(a) WITH (colocated = true);
