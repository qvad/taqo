...
class BasicOpsModel(SQLModel):
    ...
    def generate_data(self):
        ...
        if exists(f"sql/{self.config.model}/data/t1.csv"):
        ...
        if exists(f"sql/{self.config.model}/data/t2.csv"):
        ...
        if exists(f"sql/{self.config.model}/data/t3.csv"):
        ...
        if exists(f"sql/{self.config.model}/data/ts2.csv"):
        ...
        if exists(f"sql/{self.config.model}/data/ts3.csv"):
